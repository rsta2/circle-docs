...
The `Light and Versatile Graphics Library <https://lvgl.io/>`_ (LVGL) v7.11.0 can be used with Circle. This library provides an API, which is based on the C language. See the `LVGL documentation <https://docs.lvgl.io/7.11/>`_ for details.
